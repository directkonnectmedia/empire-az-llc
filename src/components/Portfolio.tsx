      ...
      <div className="container-luxe relative">
        <Reveal>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-12">
            ...
            <p className="md:max-w-sm text-white/65 leading-relaxed">
              A curated selection of recent renovations across the Arizona
              Valley. Each one custom-built, no two alike.
            </p>
          </div>
        </Reveal>
              ...
              {items.map((p, i) => (
                ...
                >
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[color:var(--color-charcoal-deep)] via-transparent to-transparent opacity-90" />
                    <div className="absolute inset-0 bg-[color:var(--color-royal-dark)]/0 group-hover:bg-[color:var(--color-royal-dark)]/15 transition-colors duration-500" />
                  </div>

                  {/* Top tag */}
                  <div className="absolute top-5 left-5 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[0.65rem] eyebrow text-white/85">
                    {p.category}
                  </div>
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-6">
                    ...
                    <div className="mt-2 text-xs text-white/65 tracking-wide">
                      {p.city}
                    </div>
                  </div>
                </motion.a>
